...
|---|---|---|---|---|---|---|---|---|
| Connectome (MaleCNS wiring, fixed) | 1.58 (n=1) | 1.59 (n=1) | 0.880 (n=1) | 0.880 (n=1) | 0.029 (n=1) | [16] | 70.3 | 7955909 |
| Degree-preserving shuffle | 1.53 (n=1) | 1.56 (n=1) | 0.876 (n=1) | 0.875 (n=1) | 0.028 (n=1) | [16] | 66.1 | 7955909 |
| Random graph, matched density | 1.82 (n=1) | 2.79 (n=1) | 0.875 (n=1) | 0.876 (n=1) | 0.037 (n=1) | [13] | 68.7 | 7955909 |
| MLP, matched parameters | 3.73 (n=1) | 3.55 (n=1) | 0.842 (n=1) | 0.832 (n=1) | 0.055 (n=1) | [8] | 0.5 | 7953594 |
| Linear readout | 3.07 (n=1) | 3.12 (n=1) | 0.583 (n=1) | 0.428 (n=1) | 0.317 (n=1) | [1] | 0.0 | 924 (closed form) |
...
|---|---|---|---|---|---|---|---|---|
| Connectome (MaleCNS wiring, fixed) | 2.44 (n=1) | 4.58 (n=1) | 5.62 (n=1) | 2.79 (n=1) | 3.77 (n=1) | 3.53 (n=1) | 4.85 (n=1) | 3.17 (n=1) |
| Degree-preserving shuffle | 2.30 (n=1) | 4.09 (n=1) | 4.76 (n=1) | 2.60 (n=1) | 3.53 (n=1) | 2.97 (n=1) | 4.50 (n=1) | 2.77 (n=1) |
| Random graph, matched density | 2.56 (n=1) | 4.60 (n=1) | 5.34 (n=1) | 2.85 (n=1) | 3.56 (n=1) | 3.25 (n=1) | 4.23 (n=1) | 2.97 (n=1) |
| MLP, matched parameters | 5.40 (n=1) | 6.41 (n=1) | 7.47 (n=1) | 5.85 (n=1) | 5.49 (n=1) | 5.15 (n=1) | 5.60 (n=1) | 5.29 (n=1) |
| Linear readout | 4.88 (n=1) | 9.13 (n=1) | 11.66 (n=1) | 2.43 (n=1) | 3.82 (n=1) | 6.09 (n=1) | 5.09 (n=1) | 1.82 (n=1) |
...
|---|---|---|---|
| Connectome (MaleCNS wiring, fixed) | 16.06 (n=1) (batch 256: 4.34 ms/record) | 0.0000 marginal API; hardware not measured | 1.000 (n=64) (two forward passes on one TEST batch per seed, bitwise equal (torch.equal)) |
| Degree-preserving shuffle | not measured (bench covers the connectome forward only) | 0.0000 marginal API; hardware not measured | 1.000 (n=64) (two forward passes on one TEST batch per seed, bitwise equal (torch.equal)) |
| Random graph, matched density | not measured (bench covers the connectome forward only) | 0.0000 marginal API; hardware not measured | 1.000 (n=64) (two forward passes on one TEST batch per seed, bitwise equal (torch.equal)) |
| MLP, matched parameters | not measured (bench covers the connectome forward only) | 0.0000 marginal API; hardware not measured | 1.000 (n=64) (two forward passes on one TEST batch per seed, bitwise equal (torch.equal)) |
| Linear readout | not measured (bench covers the connectome forward only) | 0.0000 marginal API; hardware not measured | 1.000 (n=64) (two forward passes on one TEST batch per seed, bitwise equal (torch.equal)) |
...
|---|---|---|---|---|---|---|---|
| dti | Fly recovers the DTI engine | composite MAE, recomputed from predicted dims (headline; TEST, mean over seeds) | <= 2.5 and CI upper <= 3.0 | 1.5819 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | same | tier accuracy | >= 0.90, Wilson lower >= 0.88 (n = TEST records) | 0.8798 | [0.8693, 0.8895] | 1 | **INSUFFICIENT SEEDS (1/5; point estimate misses the bar)** |
| dti | same | macro-F1 (tiers with support >= 30) | >= 0.85 | 0.8799 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | same | ECE (10 equal-mass bins) | <= 0.05 | 0.0287 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | same | per-dimension MAE, worst of 8 (no dimension is degenerate) | <= 5.0 each | 5.6232 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate misses the bar)** |
| bii | Fly recovers the BII scorer | BII MAE (0-1) | <= 0.0375 and CI upper <= 0.045 | 0.0288 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| bii | same | gate accuracy | >= 0.90 | 0.9137 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| bii | same | gate macro-F1 | >= 0.85 | 0.9061 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| bii | same | ECE | <= 0.05 | 0.0123 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | Wiring matters | delta_b = MAE(shuffle) - MAE(connectome) | >= 1.0, CI lower > 0, connectome better on every seed | -0.0557 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate misses the bar)** |
| dti | Wiring matters | delta_c = MAE(ER) - MAE(connectome) | >= 1.0, CI lower > 0, connectome better on every seed | 0.2384 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate misses the bar)** |
| dti | Fly beats the floor | MAE(ridge) - MAE(connectome) | > 0, CI lower > 0 | 1.4911 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | Fixed graph beats matched network (framing, descriptive) | MAE(MLP) - MAE(connectome) | >= 1.0, CI lower > 0, connectome better on every seed (same margin as the wiring rule; not pre-registered) | 2.1502 |  | 1 | **INSUFFICIENT SEEDS (1/5; point estimate meets the bar)** |
| dti | same, directly predicted composite head (descriptive) | delta_b, direct head | as above | -0.0293 |  | 1 | **descriptive** |
...
Pilot rule (PROTOCOL 8.3): seeds with both connectome and shuffle on DTI = [1]; s_seed of delta_b = awaiting run points; verdict: **AWAITING RUN (needs connectome and shuffle on >= 2 seeds)**.

...
<!-- STATUS: front matter, plain-language opener, attribution, intended use, COI, footer are SETTLED (legal flags 1–13 applied).
     Sections 3–6 are filled from PROTOCOL.md and the run results. No number appears here that was not produced by a run.
...
| OpenAI, `gpt-5` | `gpt-5-2025-08-07` | 2026-09-20 20:00 | reasoning_effort high | 0.0 / not accepted, the API rejects it for this model | response_format json_schema strict=true | awaiting run (protocol N = 300, k = 3); probe of 300 × 3 on this date recorded the served model | developers.openai.com pricing and model pages; retrieved 2026-09-20 |
